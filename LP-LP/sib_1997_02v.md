...
This is a variation of [sib_1997_02](/BASBLib/LP-LP/sib_1997_02) problem. The only difference is the fourth inner constraint, which is changed from `-3x + 2y + 4 <= 0` into `3x - 2y - 4 <= 0`. After this modification, the optimal solution occurs at (_x_*, _y_*) = (4.0, 4.0) with F* = -12.0 and f* = 4.0, i.e., at the same point which was reported in the literature.
