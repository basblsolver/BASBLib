...
# Original source: 
# - Example 2.4 in:
#   Dempe, S., & Dutta, J. (2012). Is bilevel programming a special case of a 
#   mathematical program with complementarity constraints?. 
#   Mathematical programming, 131(1-2), 37-48.
#
# Optimal solution:
#   F* = 1.0
#   f* = 0.0
...
#    http://basblsolver.github.io/BASBLib/QP-NLP/dd_2012_01
# ==============================================================================
